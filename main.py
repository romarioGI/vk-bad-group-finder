...
from contentAnalyzers import erotic_content_analyzer, opposition_content_analyzer

vkApiWrapper = VkApiWrapper()

access_token = '7a754fc77a754fc77a754fc7627a004af177a757a754fc725cae7e2fe78c903c9fd8417'
task2 = Task2(access_token, [erotic_content_analyzer, opposition_content_analyzer], vkApiWrapper)
